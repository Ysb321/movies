...
const FRAME_HOSTS = ["pvrplay.online", "bingr.one", "megaplay.buzz", "netout.pages.dev", "vidout.pages.dev", "cineverse.modiplay.xyz", "web.nxsha.app", "screenscape.me"]; // full sites + Server 8 players - strip any frame-block headers
