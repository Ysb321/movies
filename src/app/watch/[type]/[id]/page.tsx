...
function WatchContent() {
  ...
  /* Multi Dub (in-house FOSS player: ArtPlayer + hls.js fed by the
   * WebStreamrMBG source API) - hidden in Kids mode (fail-closed). */
  ...
  useEffect(() => {
    let cancelled = false;
    /* Multi Dub renders YetflixPlayer (own embed + resume handling) */
